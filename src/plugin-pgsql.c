...
option_t options[] = {
	...
	{ "pgsql-ignore-multiple", o_int, &pppd_pgsql_ignore_multiple, "Set PostgreSQL to cover first row from multiple rows"},
	{ "pgsql-ignore-null", o_int, &pppd_pgsql_ignore_null, "Set PostgreSQL to cover NULL results as string"},
