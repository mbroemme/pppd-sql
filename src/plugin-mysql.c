...
option_t options[] = {
	...
	{ "mysql-ignore-multiple", o_int, &pppd_mysql_ignore_multiple, "Set MySQL to cover first row from multiple rows"},
	{ "mysql-ignore-null", o_int, &pppd_mysql_ignore_null, "Set MySQL to cover NULL results as string"},
